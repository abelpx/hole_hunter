...
[![CI Status](https://img.shields.io/github/actions/workflow/status/abelpx/hole_hunter/CI?branch=master&label=CI)](https://github.com/abelpx/hole_hunter/actions/workflows/CI.yml)
